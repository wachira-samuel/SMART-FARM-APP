    ...
    <>
      ...
      <div className="bg-green-100 min-h-screen">
        ...
        <header className="bg-green-500 text-white text-center py-20">
          ...
          <button className="mt-6 px-6 py-2 bg-white text-green-500 font-bold rounded hover:bg-green-100">
            Get Started
          </button>
        </header>
        ...
        <section className="mt-12 px-6">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white shadow-md p-6 rounded">
              <h3 className="text-xl font-semibold">Automated Irrigation</h3>
              <p className="mt-2 text-gray-600">
                Optimize water usage with automated irrigation systems tailored to your crops.
              </p>
            </div>
            <div className="bg-white shadow-md p-6 rounded">
        ...
        <section className="mt-16 bg-green-700 text-white text-center py-10">
          ...
          <button className="mt-6 px-6 py-2 bg-white text-green-700 font-bold rounded hover:bg-green-100">
            Sign Up Now
          </button>
        </section>
